...
--    V1.0     S.Stevanovic   17 Apr 18     Inital Release
--    V1.1     M.Stojanovic   17 Oct 18     Update to datasheet 002-18293 Rev. *B
--    V1.2     B.Barac        19 Dec 26     Update to datasheet 002-18293 Rev. *J
--
-------------------------------------------------------------------------------
--  PART DESCRIPTION:
--
...
--         CS# High to Power Down Mode
    ...
    ---------------------------------------------------------------------------
        ...
        mem_file_name     : STRING    := "cy15v104qs.mem";
        otp_file_name     : STRING    := "cy15v104qsOTP.mem";
    ...
    ATTRIBUTE VITAL_LEVEL0 of cy15v104qs : ENTITY IS TRUE;
END cy15v104qs;

-------------------------------------------------------------------------------
-- ARCHITECTURE DECLARATION
-------------------------------------------------------------------------------
ARCHITECTURE vhdl_behavioral_static_memory_allocation of cy15v104qs IS
    ...
    CONSTANT PartID        : STRING  := "cy15v104qs";
...
--                 reset_check(1 DOWNTO 0) <= "00";
    ...
    BEGIN
    ---------------------------------------------------------------------------
    --cy15v104qs memory preload file format
    -----------------------------------
    ---------------------------------------------------------------------------
    --   /       - comment
    ...
    ---------------------------------------------------------------------------
    --cy15v104qs_otp memory preload file format
    ---------------------------------------------------------------------------
    --   /       - comment
